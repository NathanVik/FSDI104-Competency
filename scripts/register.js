...
function searchPet(){
    //getting the string in the search
    ...
    salon.pets.forEach(pet => {
        var petBox=document.getElementById(pet.id);
                //compare search string with all array names
        if(pet.name.toLowerCase().includes(searchString.toLowerCase()) || pet.service.toLowerCase().includes(searchString.toLowerCase())){
            ...
            document.getElementById(pet.id).setAttribute(`class`,`selected`);
            //petBox.classList.add(`show`);
            petBox.classList.remove(`hide`)
        }else{
            console.log(`Not here, champ`);
            //document.getElementById(pet.id).removeAttribute(`class`,`selected`);
...
function searchReset(){
    salon.pets.forEach(pet => {
        var petBox=document.getElementById(pet.id);
        petBox.classList.remove(`hide`,`selected`);
    })
}
function init(){
    console.log("init");
    ...
    document.querySelector(`#btn-reset`).addEventListener("click",searchReset);
